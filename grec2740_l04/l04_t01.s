...
CMP R0, #0x0a  // check if there is new data
...
/*
If you type in data without pressing the Enter key and run 
the program, the program will continue reading characters 
from the UART until the buffer is full, and then it will stop.
*/