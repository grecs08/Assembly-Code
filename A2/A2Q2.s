...
MOV R3,#7            // Move the value 7 into R3

LSR R3,R3,#3         // Logical shift right three times
LSR R3,R3,#3
LSR R3,R3,#3

/* The value of R3 will be 0, 
since a shift right with the shift 
amount greater than or equal to the size 
of the operand will always result in zero. 
*/
