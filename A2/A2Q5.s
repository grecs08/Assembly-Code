...
// Create a mask to set the 8th bit to 1
MOV R3, #0x00000100     // Set 8th bit to 1, all other bits to 0

// Write 1 to the 8th bit of the value in R2
ORR R2, R2, R3          // Apply the mask to the value of R2 using ORR
