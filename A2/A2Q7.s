...
// Toggle the 8th, 19th, and 25th bits of r3
...
MOV R2, #0x00040000     // Create a mask with only the 19th bit set to 1
EOR R3, R3, R2          // Apply the mask to R3 using EOR to toggle the 19th bit

MOV R2, #0x02000000     // Create a mask with only the 25th bit set to 1
EOR R3, R3, R2          // Apply the mask to R3 using EOR to toggle the 25th bit
